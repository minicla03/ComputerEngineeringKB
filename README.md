...
Utilizzo: Basta digitare new-kb e seguire le istruzioni a schermo.
...
Note Atomiche: Ogni nota deve trattare un solo concetto. Se è troppo lunga, dividila.
...
Estensioni Core: Foam, Markdown Preview Mermaid Support, Markdown All in One.

Versionamento: Git (GitHub come storage remoto).

Automazione: Python 3.10+.

Refactoring Reminder: Proprio come il codice, anche la conoscenza richiede manutenzione. Se una nota è obsoleta, aggiornala. Se una connessione manca, creala.
