...
![lifecycle_activity](assets/lifecycle_activity.png)
...
## **Back stack e navigazioene fra le app**
...
![backstack_managment](assets/backstack_managment.png)
...
![fragment_managment](assets\fragment_managment.png)

**Always Use Fragments (AUF)**: una regola informale che suggerisce di preferire i Fragment alle Activity quando possibile.
